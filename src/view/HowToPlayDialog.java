...
public class HowToPlayDialog extends JDialog {
    ...
    public HowToPlayDialog(JFrame parent) {
         ...
         * ===========================
         * KEY FIX (Layout only):
         * Use a Scrollable wrapper that TRACKS the viewport width.
         * This prevents right-side cropping when long HTML JLabel content
         * makes the preferred width larger than the viewport while
         * horizontal scrolling is disabled.
         * ===========================
         */
        ScrollableWrapper wrapperPanel = new ScrollableWrapper(new BorderLayout());
        wrapperPanel.setBackground(Color.WHITE);
        wrapperPanel.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200), 1));

        // Put the content at NORTH so it keeps its preferred height and grows downward
    ...
    /**
     * Scrollable wrapper that forces the scroll content to track the viewport width.
     * This prevents right-side cropping when horizontal scrolling is disabled.
     */
    private static class ScrollableWrapper extends JPanel implements Scrollable {
        public ScrollableWrapper(LayoutManager layout) { super(layout); }
        ...
        @Override public boolean getScrollableTracksViewportWidth() { return true; }   // KEY FIX

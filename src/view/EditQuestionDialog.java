...
public class EditQuestionDialog extends JDialog {
    ...
    public EditQuestionDialog(JFrame parent, Question question) {
        ...
        questionField = new JTextArea(question.getQuestionText(), 1, 50);
        ...
        optionAField = createTextField(question.getA());
        ...
        optionBField = createTextField(question.getB());
        ...
        optionCField = createTextField(question.getC());
        ...
        optionDField = createTextField(question.getD());
        ...
        difficultyCombo.setSelectedIndex(question.getDifficulty() - 1);
        ...
        // Force UI to respect our colors
    ...
    private void updateQuestion() {
        ...
        question.setCorrectAnswer((String) correctAnswerCombo.getSelectedItem());
        question.setDifficulty(difficultyCombo.getSelectedIndex() + 1);
    }
